...
export const projectsData: ProjectData[] = [
  ...
  },
  {
    ...
    isReverse: true,
    bhk: '4 BHK (Single residence per floor)',
  ...
  },
  {
    ...
    image: Services.p3,
    location: 'Narsingi, near Outer Ring Road, Hyderabad',
    sqft: '4,595 – 6,500 sq.ft',
    bhk: '4 BHK',
    rera: 'P02400007343',
    developer: 'Newmark UrbanSpaces (by Vamsiram Group)',
    highlights: [
    ...
    status: ': Under construction (Possession expected by Nov 2028)',
  ...
  },
  {
    ...
    location: 'Raidurgam, Gachibowli, Hyderabad',
    bhk: '4 & 6 BHK',
    rera: 'P02400006708',
