...
export const PortfolioDetailsData = [
...

  {
    ...
    paragraph: [
      ...
      "What stood out the most was the energy and determination radiating from the room. These young individuals are not just envisioning success—they are taking active steps toward achieving it. Witnessing their commitment to personal growth was both inspiring and humbling."
    ],
    bulletList: [
