...
const WorkingProcess: React.FC = () => {
  ...
  return (
    <Box sx={{ color: '#000', py: 8, height:{xs:'auto',md: '100vh'} }}>
      <Container maxWidth='lg'>
        ...
        <Grid container alignItems="start" sx={{
          ...
          <Grid item xs={12} md={7} sx={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
            <Typography variant='h6' sx={{ fontSize: 18, textAlign: 'center', color: '#000', }}>
        ...
        <Grid container spacing={4} justifyContent="center">
          {steps.map((step, i) => (
            <Grid item xs={12} md={4} key={step.id} sx={{mb:{xs:6,md:0}}}>
              ...
              >
                <Typography variant='h6' sx={{ color: 'primary.main', mb: 1, fontWeight: 700, }}>/{step.id}</Typography>
