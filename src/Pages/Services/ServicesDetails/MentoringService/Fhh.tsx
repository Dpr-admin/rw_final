                        ...
                        <Grid item xs={12} md={4} style={{ position: 'sticky', top: 0, alignSelf: 'flex-start' }}>
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    onClick={() => {
                                        setVisibleTabIndex((prev) => Math.max(prev - 1, 0));
                                    }}
                                    disabled={visibleTabIndex === 0}
                                >
                                    ◀
                                </Button>
                                    ...
                                    {tabs.map((tab, index) => (
                                        <Button
                                            ...
                                            sx={{
                                                ...
                                                display: { xs: visibleTabIndex === index ? 'block' : 'none', md: 'block' },
                                            }}
                                        >
                                            {tab.title}
                                        </Button>
                                ...
                                <Button
                                    sx={{ display: { xs: 'block', md: 'none' }, minWidth: 'auto' }}
                                    onClick={() => {
                                        setVisibleTabIndex((prev) => Math.min(prev + 1, tabs.length - 1));
                                    }}
                                    disabled={visibleTabIndex === tabs.length - 1}
                                >
                                    ▶
                                </Button>
                            </Box>
